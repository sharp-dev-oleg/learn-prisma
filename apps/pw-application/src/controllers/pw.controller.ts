...
import { Controller, Get, Post, Body, Request, UseGuards, Logger, Param } from '@nestjs/common';
...
export class PWController{
    ...
    getUser(req: any) {
        return  this.authService.getUserData(req.headers['authorization']?.split(' ')[1]);
    }
